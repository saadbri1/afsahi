        ...
        {s.cards.map((c, i) => (
          <article key={i} data-reveal-child
            ...
            <div className="relative aspect-[16/10] overflow-hidden">
              <img src={IMG[i]} alt={c.title} width="900" height="1348" loading="lazy" decoding="async"
                style={{ objectPosition: IMG_POS[i] }} className="h-full w-full object-cover transition-transform duration-[1100ms] ease-luxe group-hover:scale-[1.05]" />
            </div>
            <div className="p-8">
              ...
              <button onClick={() => scrollToHash("#book", { smooth: false })}
